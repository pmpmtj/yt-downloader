...
class MetadataExporter:
    ...
    def export_csv(self, metadata: Dict[str, Any], output_path: str) -> bool:
        ...
        try:
            ...
            flattened_data = self._flatten_metadata_for_csv(metadata)
    ...
    def export_markdown(self, metadata: Dict[str, Any], output_path: str) -> bool:
        ...
        try:
            ...
            markdown_content = self._generate_markdown_report(metadata)
    ...
    def _flatten_metadata_for_csv(self, metadata: Dict[str, Any]) -> Dict[str, Any]:
...
def export_metadata(metadata: Dict[str, Any], format_type: str, output_path: str) -> bool:
    ...
    if format_type.lower() == 'json':
        return exporter.export_json(metadata, output_path)
    elif format_type.lower() == 'csv':
        return exporter.export_csv(metadata, output_path)
    elif format_type.lower() == 'markdown':
        return exporter.export_markdown(metadata, output_path)
    else:
